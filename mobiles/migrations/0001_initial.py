# Generated by Django 2.2.15 on 2020-09-16 14:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sim_type', models.CharField(choices=[('NANO', 'Nano'), ('MICRO', 'Micro'), ('STANDARD', 'Standard')], default='NANO', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brandName', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mobiles.BrandName')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fingerprint_position', models.CharField(blank=True, choices=[('SIDE', 'Side'), ('REAR', 'REAR'), ('FRONTSIDE', 'Front Side'), ('ONSCREEN', 'Onscreen')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobileBattery', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mobiles.MobileBattery')),
                ('mobileCamera', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mobiles.MobileCamera')),
                ('mobileDisplay', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mobiles.MobileDisplay')),
                ('mobileGeneral', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mobiles.MobileGeneral')),
                ('mobileNames', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mobiles.MobileName')),
                ('mobilePerformance', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mobiles.MobilePerformance')),
                ('mobileSensor', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mobiles.MobileSensor')),
                ('mobileStorage', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mobiles.MobileStorage')),
                ('mobileVariant', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mobiles.MobileConnectivity')),
            ],
        ),
        migrations.CreateModel(
            name='OnlinePrice',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variantImage', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mobiles.MobileVariant')),
            ],
        ),
        migrations.CreateModel(
            name='VariantColor',
            fields=[
                ...
                ('variantColor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mobiles.MobileVariant')),
            ],
        ),
        migrations.AddField(
            model_name='mobilevariant',
            name='otherFeature',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mobiles.OtherFeature'),
        ),
        migrations.AddField(
            model_name='mobileconnectivity',
            name='mobileConnectivityDetails',
            field=models.ManyToManyField(to='mobiles.MobileConnectivityDetails'),
        ),
    ]
